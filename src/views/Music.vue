    ...
    <div class="feed-body">
      ...
      <div class="feed">
        <div class="feed-title">
          <div class="content-title">Музыка</div>
          <div>
            <div class="search-field">
              <button class="search-button">
                <span class="material-icons" @click="sortArray"> search </span>
              </button>
              <input
                type="search"
                class="input-search"
            ...
            <div v-show="notFound" class="search-fail">
